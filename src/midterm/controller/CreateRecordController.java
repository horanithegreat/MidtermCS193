...
**/  
public class CreateRecordController extends Controller {
    
    /**
     * Service object that will be used to call the insert to datastore function.
     */
    ...
    public Navigation run() throws Exception {
        System.out.println("CreateRecordController " + "start");
        /**
        ...
        try {
            ...
            */
            reportCardService.insertRecord(reportCardDto);
        } catch (Exception e) {
            System.out.println(e.toString());
        }
        
        System.out.println("CreateRecordController " + "end");
